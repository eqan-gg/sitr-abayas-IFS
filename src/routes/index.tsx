    ...
    <>
          ...
          <div className="order-2 md:order-1 flex items-center px-4 sm:px-6 md:px-16 lg:px-24 py-12 sm:py-16">
            ...
            >
              ...
              <p className="mt-6 text-base text-muted-foreground leading-relaxed max-w-md">
                A considered wardrobe of abayas, hijabs and modest essentials —
                cut from the season's finest fabrics, made in small batches.
              </p>
              <div className="mt-9 flex flex-wrap items-center gap-3">
                ...
                <Link to="/shop" search={{ cat: "abayas" }} className="px-7 py-4 text-xs uppercase tracking-[0.25em] border-b border-ink hover:opacity-70">
      ...
      <section className="max-w-[1400px] mx-auto px-5 md:px-10 py-20 md:py-28">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-5">
          {categories.map((c, i) => (
            ...
            >
              <Link to="/shop" search={{ cat: c.slug }} className="group block">
      ...
      <section className="max-w-[1400px] mx-auto px-5 md:px-10 py-20 md:py-28">
        <div className="flex items-end justify-between mb-10 md:mb-14">
          ...
          <Link to="/shop" className="hidden md:inline text-xs uppercase tracking-[0.22em] border-b border-ink pb-1">Shop all</Link>
        </div>
